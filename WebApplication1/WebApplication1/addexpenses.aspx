<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="addexpenses.aspx.vb" Inherits="WebApplication1.addexpenses" %>
    ...
    <div class="card mar mx-auto" style="max-width: 400px;"> <!-- Adjust max-width as needed -->
        <div class="card-body">
            ...
            <div class="form-floating">
                <asp:TextBox ID="item" runat="server" CssClass="form-control" placeholder="Item" required ></asp:TextBox>
                <label for="item">Item</label>
            </div>
            <div class="form-floating mb-3">
            </div>
            <div class="form-floating">
                <asp:TextBox ID="costofitem" runat="server" CssClass="form-control" placeholder="Cost of item" required ></asp:TextBox>
        ...
        <div class="text-center">
            <div class="card-footer">
                ...
                <asp:Button runat="server" ID="Button1" Text="Add" CssClass="btn btn-success" OnClick="Button1_Click" />
